# 📊 Sistem Deteksi Prioritas Penanganan Anak Tidak Sekolah (ATS)

**Proyek Tugas Besar - Applied Machine Learning**

Proyek ini mengimplementasikan algoritma **Unsupervised Learning, K-Means Clustering**, untuk melakukan segmentasi wilayah di Indonesia berdasarkan tingkat keparahan masalah **Anak Tidak Sekolah (ATS)** di jenjang SD/MI sederajat. Tujuannya adalah mentransformasi data statistik mentah menjadi alat bantu pendukung keputusan yang dapat memprioritaskan intervensi kebijakan pendidikan secara efektif.
